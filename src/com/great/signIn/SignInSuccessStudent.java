...
/**
 * Servlet implementation class SignInSuccessStudent
 */
public class SignInSuccessStudent extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SignInSuccessStudent() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
	      ...
	      System.out.println("place_id"+ place_id );
			...
			String sql;
			sql="select * from t_signIn where place_id ='"+place_id+"'";
...
//						System.out.println("utils success");
				    ...
				    String sign_stuId   = resultSet.getString("sign_stuId");
				    System.out.println("sign_stuId      "+sign_stuId);
				    String sign_stuName = resultSet.getString("sign_stuName");
				    System.out.println("sign_stuName      "+sign_stuName);
				    String sign_stuSeat = resultSet.getString("sign_stuSeat");
				    System.out.println("sign_stuSeat      "+sign_stuSeat);
						stringer.object();
						
						stringer.key("sign_stuId");
						stringer.value(sign_stuId);
						stringer.key("sign_stuName");
						stringer.value(sign_stuName);
						stringer.key("sign_stuSeat");
						stringer.value(sign_stuSeat);

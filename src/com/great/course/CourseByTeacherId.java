...
/**
 * Servlet implementation class CourseByTeacherId
 */
public class CourseByTeacherId extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public CourseByTeacherId() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			String sql;
			sql="select * from v_teacher_course where teacher_id ='"+teacher_id+"'";
			...
			stringer.array();
				...
				while (resultSet.next()) {
						...
						String teacher_idBack = resultSet.getString("teacher_id");
						System.out.println("teacher_idBack    "+teacher_idBack);
						...
						stringer.key("teacher_name");
						stringer.value(teacher_name);
